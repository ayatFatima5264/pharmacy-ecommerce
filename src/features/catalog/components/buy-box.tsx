 ...
 *
 * It is the only client component on the PDP — the description, clinical
 * accordions, and related products all stay server-rendered.
 */
    ...
    <div className="flex flex-col gap-5">
      ...
      <ul className="flex flex-col gap-2.5 border-t border-gray-200 pt-5 text-body-sm text-gray-500">
        <li className="flex items-center gap-2.5">
          <Truck className="h-4 w-4 shrink-0 text-gray-400" aria-hidden="true" />
          Free delivery on orders over Rs 2,000
        </li>
        <li className="flex items-center gap-2.5">
          <RotateCcw className="h-4 w-4 shrink-0 text-gray-400" aria-hidden="true" />
...
export function StickyBuyBar({ product }: { product: Product }) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-14 z-40 animate-slide-up border-t border-gray-200 bg-white p-3 md:hidden">
