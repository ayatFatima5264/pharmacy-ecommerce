      ...
      <div className="flex flex-col gap-2.5 sm:flex-row sm:flex-wrap sm:items-center">
        <div className="relative min-w-0 flex-1 sm:max-w-xs">
          ...
          <input
            ...
            className="h-10 w-full rounded-md border border-gray-200 bg-white pl-9 pr-3 text-[13.5px] text-gray-900 shadow-e1 transition-all duration-medium placeholder:text-gray-400 focus:border-blue-600 focus:outline-none focus:ring-[3px] focus:ring-blue-100"
          />
        </div>
        ...
        {selects.map((select) => (
          <div key={select.key}>
            ...
            <select
              ...
              className={cn(
                'h-10 cursor-pointer rounded-md border bg-white px-3 pr-8 text-[13.5px] shadow-e1 transition-all duration-medium focus:border-blue-600 focus:outline-none focus:ring-[3px] focus:ring-blue-100',
        ...
        {hasFilters && (
          <button
            ...
            className="flex h-10 items-center gap-1.5 rounded-md px-3 text-[13px] font-semibold text-gray-500 transition-colors duration-fast hover:bg-red-50 hover:text-red-600"
          >
